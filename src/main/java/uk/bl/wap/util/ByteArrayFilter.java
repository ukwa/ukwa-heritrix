...
/**
 * ByteArrayFilter is used to filter out duplicate byte arrays from a given
 * dataset or stream. It is guaranteed to never return a false positive (that
 * is, it will never say that an item has already been seen by the filter when
 * it has not) but may return a false negative.
 * 
 * ByteArrayFilter is thread-safe.
 * 
 * @see {@link https://www.somethingsimilar.com/2012/05/21/the-opposite-of-a-bloom-filter/}
 * @see {@link https://github.com/jmhodges/opposite_of_a_bloom_filter}
 * @see {@link https://github.com/jmhodges/opposite_of_a_bloom_filter/blob/master/LICENSE}
 *
 */
