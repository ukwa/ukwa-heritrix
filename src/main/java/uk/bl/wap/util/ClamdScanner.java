...
public class ClamdScanner {
    ...
    private final static Logger LOGGER = Logger.getLogger(ClamdScanner.class
.getName());
        ...
        try {
            ...
            try {
                while ((read = input.read(buffer)) != -1) {
                    ...
                    try {
                        ...
                        LOGGER.log(Level.WARNING,
                                "Error writing to DataOutputStream: "
                                        + e.toString());
                        break;
                    }
                }
                ...
                LOGGER.log(Level.SEVERE,
                        "Error reading from InputStream: " + e.toString(), e);
            }
            ...
            if (output != null) {
                try {
                    ...
                    LOGGER.log(Level.WARNING,
                            "Error closing DataOutputStream: " + e.toString());
                }
            }
            try {
                socket.close();
    ...
    private String getResponse(Socket socket) {
        ...
        while (response.length() <= 128) {
            try {
                ...
                LOGGER.log(Level.WARNING,
                        "ClamdScanner.getResponse(): " + e.toString());
                break;
            }
