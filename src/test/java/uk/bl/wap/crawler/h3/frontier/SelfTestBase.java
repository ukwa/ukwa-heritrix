...
/**
 * Base class for 'self tests', integrations tests formatted as unit tests,
 * where the crawler launches an entire crawl exercising multiple features
 * against a test harness website.
 * 
 * Copied from heritrix-engine as it appeared not to be available via Maven.
 * 
 * @contributor pjack
 * @contributor gojomo
 */
